...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4525479;
      var PACKAGE_UUID = '38c36298-84b1-4f84-a83c-dbd65ca09e5f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 26788, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(26788, 57444, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(57444, 64664, 0, 0).open('GET', '/level0');
    new DataRequest(64664, 202516, 0, 0).open('GET', '/level1');
    new DataRequest(202516, 202537, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(202537, 215299, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(215299, 283107, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(283107, 305506, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(305506, 902630, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(902630, 2939754, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2939754, 4437126, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4437126, 4497854, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(4497854, 4525479, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
